...
// (type || cp(e) ? car(e) == sym && (cdr(e) >> 4) == type : e == sym)
...
// Object to cons. Cons objects' layout is special. First slot is car second
// slot is cdr.  But last bits of second slot also obey the type
// declaration rules for ather lisp obects.
lval* o2c(lval o) {
	return (lval*) (o - 1);
}
...
// object to lisp array
lval* o2a(lval o) {
  return (lval*) (o - 2);
}

// lisp array to object
lval a2o(lval* a) {
  return (lval) a + 2;
}
